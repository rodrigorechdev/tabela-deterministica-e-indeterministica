...
public class ConversorTabelaDeterministica {
     ...
     * @param tabelas
     */
    public Tabelas criaTabelaNaoDinamica(Tabelas tabelas) {
        ...
        while(existeIndeterminismo) {
            ...
            if(chaveIndeterminismo == null) {
                ...
                this.removeIndeterminismo(tabelaDeterministica, chaveIndeterminismo, estadosFinais);
            }
        }          
    ...
    private String encontraIndeterminismo(HashMap<String, List<String>> tabelaDeterministica) {
        ...
        return null;//não há indeterminismo
    }

    private void removeIndeterminismo(HashMap<String, List<String>> tabelaDeterministica, String chaveDeterminismo, List<String> estadosFinais){
        ...
        String nomeDoNovoEstado1 = naoTerminal0 + naoTerminal1;
        String nomeDoNovoEstado2 = naoTerminal1 + naoTerminal0;
    ...
    private void ajustaEstadosFinais(String estadoAntigo, String estadoNovo, List<String> estadosFinais) {
        if(!estadoAntigo.equals("S")) {
            if(estadosFinais.contains(estadoAntigo) && !estadosFinais.contains(estadoNovo)) {
                estadosFinais.remove(estadoAntigo);
    ...
    public String criaNovoEstadoDeterministico(HashMap<String, List<String>> tabela, String naoTerminal0, String naoTerminal1){
        ...
        if(this.encontraSeEstadoJaExiste(tabela, naoTerminal1 + naoTerminal0)){
            nomeNovoEstado = naoTerminal1 + naoTerminal0;
        }
        else{
            nomeNovoEstado = naoTerminal0 + naoTerminal1;
        }
